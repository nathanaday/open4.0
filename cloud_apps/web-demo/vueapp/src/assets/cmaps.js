...
const magma = [[0.001462, 0.000466, 0.013866],
...
const inferno = [[0.001462, 0.000466, 0.013866],
...
export default class ColorMap {
    ...
    getColorFromMap(value, colorMapName) {
        const colorMap = this.colorMaps[colorMapName];
        if (!colorMap) {
            console.error(`Color map ${colorMapName} not found.`);
            return null;
        }
        ...
        return new THREE.Color(`rgb(${Math.round(r * 255)}, ${Math.round(g * 255)}, ${Math.round(b * 255)})`);
    }
}
